...
All the environments are registered in the `amazing` extension. They start
...
import amazing.tasks  # noqa: F401


def main():
    """Print all environments registered in `amazing` extension."""
