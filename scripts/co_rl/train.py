...
# when running this file directly (e.g. `python scripts/co_rl/train.py`).
...
from core.runners import OnPolicyRunner, SRMOnPolicyRunner, OffPolicyRunner
...
from amazing.amazing.isaaclab.isaaclab.envs import ManagerBasedConstraintRLEnv, ManagerBasedConstraintRLEnvCfg
...
"""Use CO-RL Wrapper."""
from core.wrapper.rl_cfg import CoRlPolicyRunnerCfg
from core.wrapper.vecenv_wrapper import CoRlVecEnvWrapper


# Import extensions to set up environment tasks
import amazing.amazing.tasks  # noqa: F401
