...
class OnPolicyRunner:
        ...
        for it in range(start_iter, tot_iter):
            ...
            with torch.inference_mode():
                for i in range(self.num_steps_per_env):
                    ...
                    iter_reward_sum += rewards.mean().item()
                    iter_reward_count += 1
                ...
                iter_mean_step_reward = iter_reward_sum / max(iter_reward_count, 1)
    ...
    def log(self, locs: dict, width: int = 80, pad: int = 35):
        ...
        self.writer.add_scalar("Train/mean_step_reward", locs["iter_mean_step_reward"], locs["it"])
